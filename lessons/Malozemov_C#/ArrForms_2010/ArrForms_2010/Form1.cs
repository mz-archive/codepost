...
namespace ArrForms
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)// Создать
        {
            sum = 0;
            string s = "";
        ...
        private void button4_Click(object sender, EventArgs e) //Сортировать
        {
            int temp = 0;
            for (i = 0; i < count; i++)
            {
        ...
        private void button5_Click(object sender, EventArgs e)//Стандартное отклонение
        {
            double So = 0;
            double SoResult = 0;
            double sr = sum / count;
